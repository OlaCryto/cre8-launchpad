...
function DashboardLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="min-h-screen bg-cre8-base overflow-x-hidden">
      <Sidebar />
      {/* Desktop: offset for sidebar. Mobile: no offset, bottom padding for nav bar */}
      <main className="md:ml-[68px] pb-16 md:pb-0">
        {children}
      </main>
    </div>
  );

...
const PAGES: Record<string, { title: string; content: string[] }> = {
  terms: {
    ...
    content: [
      ...
      '7. Graduation — When a token reaches the graduation threshold (69,000 AVAX market cap), liquidity is automatically migrated to TraderJoe DEX and LP tokens are locked for 1 year.',
